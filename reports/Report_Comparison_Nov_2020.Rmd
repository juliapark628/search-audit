...
all_queries_jan_2020_filename <- "/Users/juliapark/GitHub/Lab_Legal_Design/search_audit/processed_data/FL_HI_audit_Jan_2020/all_queries_complete.csv"
...
#   write_csv("most_common_url_filtered.csv")
# 
# all_queries_jan_2020 %>%
#   filter(!is.na(url)) %>%
#   count(url, sort = TRUE) %>%
#   write_csv("most_common_links_filtered.csv")
# 
# all_queries_jan_2020 %>%
#   write_csv("all_queries_filtered.csv")
# 
# 
# all_tables %>%
#   filter(!is.na(full_url)) %>%
