---
title: 'Search Audit Report: Northern Florida and Hawaii Queries'
output:
  github_document:
    toc: true
  html_document:
...
all_tables %>% 
  ...
  labs(
    title = "Percent of ads on a given search page", 
    subtitle = "Domestic violence has the largest proportion of ads, eviction queries have the least",
    x = "Legal query type",
    y = "Percent"
  ) 
```
